...
setwd(paste0(getwd(), "/Data_Cross_sample"))
...
Sequence_Features <- cbind(Kmer(SequenceData), ENAC(SequenceData), PS(SequenceData), PseE2P(SequenceData), DPCP(SequenceData), NCP(SequenceData), ANP(SequenceData), PSTNP(SequenceData, model="DC1_Full"), PseNAC(SequenceData))
